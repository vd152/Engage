...
router.get('/', passport.authenticate('jwt',{session: false}), controller.getGroups)
...
router.put('/:id', passport.authenticate('jwt',{session: false}), checkPermission, controller.editGroup)
